...
- Implemented secure role-based access control with cloud-based architecture
- **Currently in active production**, reducing manual record-keeping time by **85%** and eliminating **95%** of data-entry errors
- LaTeX compilation and PDF generation using custom-made microservices called via RESTful API

## Technologies
MERN Stack, MongoDB, Cloud Computing, React.js, Node.js, Express.js, MongoDB Atlas
